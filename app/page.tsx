...
import { useBudget, getCurrentMonth, formatINR, getTransactionsByMonth } from "@/context/BudgetContext";
...
export default function DashboardPage() {
  ...
  return (
    ...
    <div>
      <TopBar
  title={`Good ${getGreeting()}, Traveller`}
...
/>
      ...
      <div className="grid grid-cols-3 gap-4 mb-10">
        <StatCard
          ...
          subColor={vsLastMonth !== null && vsLastMonth > 0 ? "danger" : "success"}
        />
        <StatCard
        ...
        <StatCard
          ...
          sub={summary.isOverBudget ? "⚠ Over budget this month" : "You're on track"}
      ...
      <div className="gradient-primary rounded-2xl px-8 py-7 mb-10 flex items-center justify-between">
        <div>
          <p className="label-engraved text-white/50 mb-2">Current Liquidity</p>
        ...
        {summary.plan && (
          <div className="bg-white/10 rounded-xl px-6 py-4 text-right min-w-[180px]">
            <p className="label-engraved text-white/50 mb-1">Monthly Budget Goal</p>
      ...
      {/* ── Two column: buckets + recent ── */}
      <div className="grid grid-cols-5 gap-8">

        {/* Left: Bucket progress */}
